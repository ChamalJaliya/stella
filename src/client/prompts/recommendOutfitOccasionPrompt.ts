export const recommendOutfitOccasionPrompt = (
  ...
  Assist me in suggesting outfit recommendation for my occasion based on a celebrity's fashion choices. Consider personal style preferences, specific context on the celebrity's style, and the items I already own.
  ...
  outfit tailored to your occasion
  ...
  Provided the Existing Wardrobe, prepare a outfit collection for the ${occasion} occasion inspired by ${celebrityName}.
