export const capsuleCollectionPrompt = (
...
Assist me in creating a capsule wardrobe for my profession based on a celebrity's fashion choices. Consider personal style preferences, specific context on the celebrity's style, and the items I already own.
...
A capsule wardrobe tailored to your profession
Outfit ensembles for different professional occasions (e.g., meetings, presentations, casual Fridays)
...
Here is a Capsule Collection for the Architecture professional inspired by Meghan Markle's style: 
...
Provided the Existing Wardrobe, prepare a capsule collection for the ${profession} profession inspired by ${celebrityName}.
